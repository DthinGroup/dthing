 ...
 */
static int isArrayInstanceOfArray(const ClassObject* subElemClass, int subDim, const ClassObject* clazz)
{
 ...
 */
bool_t dvmCanPutArrayElement(const ClassObject* objectClass, const ClassObject* arrayClass)
{
 ...
 */
static int isInstanceof(const ClassObject* instance, const ClassObject* clazz)
{
