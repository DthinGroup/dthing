 ...
 */
ArrayObject* dvmGetDeclaredFields(ClassObject* clazz, bool_t publicOnly);
 ...
 */
ArrayObject* dvmGetDeclaredConstructors(ClassObject* clazz, bool_t publicOnly);
 ...
 */
ArrayObject* dvmGetDeclaredMethods(ClassObject* clazz, bool_t publicOnly);
 ...
 */
bool_t dvmUnboxPrimitive(Object* value, ClassObject* returnType,
    JValue* pResult);
 ...
 */
bool_t dvmIsClassAnnotationPresent(const ClassObject* clazz, const ClassObject* annotationClazz);
bool_t dvmIsMethodAnnotationPresent(const ClassObject* clazz, const Method* method,
        const ClassObject* annotationClazz);
bool_t dvmIsFieldAnnotationPresent(const ClassObject* clazz, const Field* method,
        const ClassObject* annotationClazz);
 ...
 * functions.
 */
typedef struct AnnotationValue_s {
    JValue  value;
    u1      type;
} AnnotationValue;
 ...
 */
typedef struct EncodedArrayIterator_s {
 ...
 */
bool_t dvmEncodedArrayIteratorGetNext(EncodedArrayIterator* iterator, AnnotationValue* value);
