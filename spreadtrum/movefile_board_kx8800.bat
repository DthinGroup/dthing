...
copy %SRCDIR%\spreadtrum\export\KX8800\SC6530.modules  %DESDIR%\..\
...
copy %SRCDIR%\spreadtrum\export\KX8800\sc6500_modem\os_app_cfg.c  %DESDIR%\..\MS_Customize\source\product\config\sc6500_modem\
copy %SRCDIR%\spreadtrum\export\KX8800\sc6530_modem\os_app_cfg.c  %DESDIR%\..\MS_Customize\source\product\config\sc6530_modem\
endlocal