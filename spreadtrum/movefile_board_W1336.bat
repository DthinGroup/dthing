...
set EXPORT_SOURCE_ROOT=%SRCDIR%\spreadtrum\export\W1336
...
XCOPY /R /Y %EXPORT_SOURCE_ROOT%\project_sc6500_16X32_modem.mk  %DESDIR%\
XCOPY /R /Y %EXPORT_SOURCE_ROOT%\project_sc6500_16X32_modem_notrace.mk  %DESDIR%\
...
XCOPY /R /Y %EXPORT_SOURCE_ROOT%\MS_Customize\source\common\prod_param.c %DESDIR%\MS_Customize\source\common\
