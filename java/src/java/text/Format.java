...
public abstract class Format implements Serializable, Cloneable {
    ...
    String convertPattern(String template, String fromChars, String toChars,
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (!quote && (index = fromChars.indexOf(next)) != -1) {
                ...
                throw new IllegalArgumentException("Invalid pattern char " + String.valueOf(next) + " in " + template); //$NON-NLS-1$
            } else {
                output.append(next);
            }
        }
        if (quote) {
            ...
            throw new IllegalArgumentException("Unterminated quote"); //$NON-NLS-1$
        }
    ...
    static boolean upToWithQuotes(String string, ParsePosition position,
        ...
        throw new IllegalArgumentException("Unmatched braces in the pattern"); //$NON-NLS-1$
    }
