...
public final class URL implements java.io.Serializable {
    ...
    transient URLConnection urlConn;
    ...
    public URL(URL context, String spec, URLStreamHandler handler) throws MalformedURLException
    {
		...
		try {
		    ...
		    URLHandle.parseURL(this, spec, start, limit);
    ...
    public boolean equals(Object obj) 
    {
        ...
        return URLHandle.equals(this, u2);
    }
    ...
    public boolean sameFile(URL other) {
        return URLHandle.sameFile(this, other);
    }
    ...
    */
    ...
    public String toExternalForm() {
    	return URLHandle.toExternalForm(this);
    }
    ...
    public URLConnection openConnection() throws java.io.IOException {
    	...
    	if(protocol.equals("http")){
    		urlConn = new HttpURLConnection(this);
    		return urlConn;
    	}
    	
    	throw new java.io.IOException("unsupport protocol:" + protocol);
    }
...
/*    
    ...
    {
    	throw new IOException("not support the method for now!");
    }
*/
}
