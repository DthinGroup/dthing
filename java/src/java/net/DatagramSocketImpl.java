...
public abstract class DatagramSocketImpl implements SocketOptions {
     ...
     */
    protected volatile int  sockHandle;
    ...
    /**
     * Gets the {@code socket handle} of this datagram socket, which is invalid
     * if the socket is closed or not bound.
     *
     * @return the current fsocket handle of this socket.
     */
    protected int getSocketHandle() {
        return sockHandle;
    }
